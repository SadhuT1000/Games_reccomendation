...
class Games(models.Model):
    ...
    platforms = models.CharField(max_length=50, verbose_name="Игровая платформа", null=True, blank=True)
...
class Developer(models.Model):
    ...
    description = models.TextField(
        blank=True, null=True, verbose_name="Описание и какие еще игры выпускали"
    )
...
class Interaction(models.Model):
    ...
    game_count = models.PositiveIntegerField(
        verbose_name="Количество рекомендованных игр", null=True, blank=True, default=0
    )
    genre_count = models.PositiveIntegerField(
